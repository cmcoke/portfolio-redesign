...
const Projects = () => {
  return (
    <section className="mx-[5%] mt-[clamp(4rem,3.143rem_+_4.286vw,10rem)] mb-[clamp(6rem,3.714rem_+_11.429vw,22rem)]" id="projects">
      <h2 className={`${helveticaNowDisplayBold.className} text-[clamp(1rem,0.929rem_+_0.357vw,1.5rem)] uppercase mt-[2rem]`}>Projects:</h2>
      ...
      <div className="mt-[6rem]">
        <h2 className={`${helveticaNowDisplayBold.className} text-[clamp(1rem,0.929rem_+_0.357vw,1.5rem)] uppercase mt-[2rem] mb-[1rem]`}>Work Experience:</h2>
        <Experience />
      </div>
    </section>
  );
